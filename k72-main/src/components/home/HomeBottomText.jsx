...
const HomeBottomText = () => {
  ...
  return (
    <div className='font-[font2] flex items-center justify-center gap-7 '>
      <p className='absolute lg:w-[17vw] w-64 lg:top-90 lg:right-20 right-20 bottom-35  lg:bottom-72 font-sans lg:text-[1vw] font-bold text-xs lg:leading-relaxed leading-tight'>
      ...
      <div className='lg:border-3 border-2 hover:border-[#D3FD50] hover:text-[#D3FD50] lg:h-30 flex items-center px-4 pt-1 lg:px-14 border-white rounded-full uppercase'>
        <Link className='text-[4vw] lg:mt-6' to='/about'>Members</Link>
      </div>
    </div>
  )
}
