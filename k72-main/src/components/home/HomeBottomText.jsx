...
const HomeBottomText = () => {
  ...
  return (
    <div className='font-[font2] flex items-center justify-center gap-7 '>
      <p className='absolute lg:w-[17vw] w-64 lg:top-90 lg:right-20 right-0 bottom-35  lg:bottom-72 font-[font1] lg:text-[1vw] text-xs lg:leading-relaxed leading-tight'>
